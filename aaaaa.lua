...
getgenv().ValiantAimHacks = {
    ...
    BlacklistedTeams = {
        {
            Team = LocalPlayer.Team,CREMATOR,Combine,Combine Soldier,Dagger,Earth Admin,Elite Metro Police,Elite Unit,Menu,Infestation Control,Ordinal,Overwatch Grunt,SHOCK,Supressor,WALLHAMMER,Ranger,GRID,SWORD,RAZOR,CWU,Helix
